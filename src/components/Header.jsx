...
export default function Header() {
  return (
    <div className='bg-[url("/images/hero-bg.jpg")]'>
      <div className='flex flex-col md:flex-row items-center pt-8 w-full px-4 md:px-20 justify-center  bg-[url("/images/hero-bg-shape.png")] min-h-[85vh] bg-cover bg-center bg-no-repeat relative'>
        <div className='space-y-6 w-full md:w-[50%] p-4 md:p-0 animate-fadeIn text-center md:text-left'>
            ...
            <button className='bg-orange-500 text-white px-6 md:px-8 py-3 md:py-4 rounded-full hover:bg-orange-800 transition-all duration-300 transform hover:scale-105 font-semibold shadow-lg animate-bounce'>Book A Table</button>
        </div>

        <div className='w-full md:w-[50%] transform hover:scale-105 transition-all duration-500 mt-8 pr-12 md:mt-0'>
            <img
